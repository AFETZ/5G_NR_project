...
### Детально по структуре скриптов
    ...
    main_scripts:
        ...
        parser_factory.py - скрипт с реализацией фабрики парсеров (надеюсь правильно шаблон назвал), которую используем
                            как универсальный инструмент для автоматического выбора парсера, способного считать наш 
                            источник. Название класса ParserFactory
